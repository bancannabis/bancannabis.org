...
import VueIconChevronLeft from '@/components/atoms/icons/icons/VueIconChevronLeft.vue';
import VueIconChevronRight from '@/components/atoms/icons/icons/VueIconChevronRight.vue';
import VueText from '@/components/layout/navigation/VueText/VueText.vue';
