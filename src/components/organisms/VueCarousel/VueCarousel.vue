<template>
  ...
  >
    <fade-animation v-for="(image, idx) in preloadedImages" :key="idx">
      <a :class="$style.a" :href="image.getAttribute('title')" target="_blank" rel="noopener noreferrer">
        <div
...
import VuePagination from '@/components/layout/navigation/VuePagination/VuePagination.vue';
