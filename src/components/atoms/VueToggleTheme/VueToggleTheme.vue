<template>
  <div class="btn" :class="$style.btn">
    ...
    />
    <label for="check">
      <div class="box" :class="$style.box">
        <div class="ball" :class="$style.ball"></div>

        <div class="scenary" :class="$style.scenary">
          <div class="moon">
...
.ball {
  @include common(null, null, null, null, $scale/2, $scale/2, #9f10ca);
  position: absolute;
  border-radius: 50%;
